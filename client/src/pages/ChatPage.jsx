...
const ChatPage = () => {
  ...
  return (
    <HeroHighlight>
        ...
        <div className="px-20 py-14 flex-grow">
          ...
          <div className="w-full mx-auto flex flex-col">
            ...
            >
              ...
              <span className="text-md inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 hover:bg-[#050c2e] transition-all duration-150 ease-in px-3 py-1 font-bold text-white backdrop-blur-3xl">
                {isLoading ? (
      ...
      <button
        className={`fixed bottom-6 right-8 h-10 w-36 inline-flex h-10 overflow-hidden rounded-lg p-[1px] ${focusStyles}`}
